...
type RemoteFormWithGroup = FormSchemaRemoteMcp & { group?: string }

const DEFAULT_FORM_VALUES: RemoteFormWithGroup = {
  name: '',
...
export function DialogFormRemoteMcp({
  ...
  const form = useForm<RemoteFormWithGroup>({
