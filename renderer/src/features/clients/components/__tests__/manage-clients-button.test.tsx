...
describe('ManageClientsButton', () => {
  ...
  const renderWithProviders = (props: { groupName: string; variant?: string; className?: string }) => {
    return render(
  ...
  describe('Parametric tests for different group names', () => {
    const testCases = [
      { groupName: 'default', expectedDescription: 'Configure clients for group: default' },
      { groupName: 'research-team', expectedDescription: 'Configure clients for group: research-team' },
      { groupName: 'development', expectedDescription: 'Configure clients for group: development' },
      { groupName: 'production', expectedDescription: 'Configure clients for group: production' },
    ]
    ...
    const testCases = [
      {
        ...
        result: { enableVSCode: true, enableCursor: true, enableClaudeCode: true },
      },
      {
        name: 'no clients enabled',
        result: { enableVSCode: false, enableCursor: false, enableClaudeCode: false },
      },
      {
        name: 'only VS Code enabled',
        result: { enableVSCode: true, enableCursor: false, enableClaudeCode: false },
      },
      {
        name: 'only Cursor enabled',
        result: { enableVSCode: false, enableCursor: true, enableClaudeCode: false },
      },
      {
        name: 'only Claude Code enabled',
        result: { enableVSCode: false, enableCursor: false, enableClaudeCode: true },
      },
      {
        name: 'VS Code and Claude Code enabled',
        result: { enableVSCode: true, enableCursor: false, enableClaudeCode: true },
      },
    ]
