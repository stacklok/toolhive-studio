...
["Report a Vulnerability"](https://github.com/liamstorkey-elmo/toolhive-studio/security/advisories/new)
tab.
...
- Create a new
  ...
  `https://github.com/liamstorkey-elmo/toolhive-studio/security/advisories/new`
